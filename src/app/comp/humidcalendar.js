...
const Calendarmain = ({
  ...
  // console.log("getDatesOfMonth :- ", getDatesOfMonth);
    ...
    return (
      ...
      >
        <CalendarHeatmap
          ...
          endDate={lastDate}
          values={currentHumidIotData}
          classForValue={(value) => {
            if (value != null) {
              if (value.humidity === "") {
                return "color-empty";
              } else if (value.humidity >= 0 && value.humidity <= 30) {
                return "color-h-low";
              } else if (value.humidity > 30 && value.humidity <= 60) {
                return "color-h-medium";
              } else if (value.humidity > 60 && value.humidity <= 100) {
                return "color-h-high";
              }
            }
          }}
